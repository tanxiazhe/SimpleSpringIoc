...
public interface BeanDefinition {
   ...
   * overriding/inheriting the class name from its parent. Hence, do <i>not</i> consider this to be the definitive bean
   * type at runtime but rather only use it for parsing purposes at the individual bean definition level.
   */
   ...
   *
   * @param factoryMethodName static factory method name, or {@code null} if normal constructor creation should be used
