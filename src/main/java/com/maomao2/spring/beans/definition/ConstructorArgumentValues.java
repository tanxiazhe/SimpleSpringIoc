...
public class ConstructorArgumentValues {
     ...
     *            the index in the constructor argument list
     * @param requiredType
     *            the type to match (can be {@code null} to match
     *            untyped values only)
     ...
     * 
     * @param requiredType
     *            the type to match (can be {@code null} to find
     *            an arbitrary next generic argument value)
     * @param requiredName
     *            the name to match (can be {@code null} to not
     ...
     *            the index in the constructor argument list
     * @param requiredType
     *            the parameter type to match (can be {@code null}
     *            to find an untyped argument value)
     * @param requiredName
     *            the parameter name to match (can be {@code null}
