...
public class ConstructorArgumentValues {
   ...
   * @param index the index in the constructor argument list
   * @param requiredType the type to match (can be {@code null} to match untyped values only)
   * @param requiredName the type to match (can be {@code null} to match unnamed values only, or empty String to match
   * any name)
   * @return the ValueHolder for the argument, or {@code null} if none set
   */
   ...
   * to allow for merging and re-merging of argument value definitions. Distinct ValueHolder instances carrying the same
   ...
   * @param requiredName the name to match (can be {@code null} to not match argument values by name, or empty String to
   * match any name)
   ...
   * @param requiredName the parameter name to match (can be {@code null} to find an unnamed argument value, or empty
   * String to match any name)
   * @param usedValueHolders a Set of ValueHolder objects that have already been used in the current resolution process
   * and should therefore not be returned again (allowing to return the next generic argument match in case of multiple
