...
public class MutablePropertyValues implements PropertyValues {
   ...
   * <p>
   * This is an accessor for optimized access to all PropertyValue objects. It is not intended for typical programmatic
   * use.
   */
   ...
   *
   * @param other Map with property values keyed by property name, which must be a String
  ...
  /**
   * Add a PropertyValue object, replacing any existing one for the corresponding property or getting merged with it (if
   * applicable).
   *
