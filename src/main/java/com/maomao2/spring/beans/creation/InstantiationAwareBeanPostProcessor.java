 ...
 * far as possible, or to derive from {@link InstantiationAwareBeanPostProcessorAdapter} in order to be shielded from
...
public interface InstantiationAwareBeanPostProcessor extends BeanPostProcessor {
   ...
   * further processing applied is the {@link #postProcessAfterInitialization} callback from the configured {@link
   * BeanPostProcessor BeanPostProcessors}.
   * <p>
   * This callback will only be applied to bean definitions with a bean class. In particular, it will not be applied to
   * beans with a "factory-method".
   * <p>
   ...
   * @return the bean object to expose instead of a default instance of the target bean, or {@code null} to proceed with
   ...
   * <p>
   * This is the ideal callback for performing field injection on the given bean instance. See Spring's own {@link
   * org.springframework.beans.factory.annotation.AutowiredAnnotationBeanPostProcessor} for a typical example.
   * <p>
   ...
   * @param pds the relevant property descriptors for the target bean (with ignored dependency types - which the factory
   * handles specifically - already filtered out)
