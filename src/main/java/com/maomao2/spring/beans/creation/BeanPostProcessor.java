...
public interface BeanPostProcessor {
   ...
   * by the FactoryBean (as of Spring 2.0). The post-processor can decide whether to apply to either the FactoryBean or
   * created objects or both through corresponding {@code bean instanceof FactoryBean} checks.
   * <p>
   * This callback will also be invoked after a short-circuiting triggered by a {@link
