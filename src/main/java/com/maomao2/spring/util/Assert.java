 ...
 *
 * <p>
 * This class is similar to JUnit's assertion library. If an argument value is deemed invalid, an {@link
...
public abstract class Assert {
   ...
   *            the array to check
   * @throws IllegalArgumentException
   *             if the object array is {@code null} or
   ...
   * @param type the type to check against
   * @param obj the object to check
   * @param messageSupplier a supplier for the exception message to use if the assertion fails; the message will be
   * prepended to the message generated by this method in order to provide further context. It should normally end in
   ...
   * @param type the type to check against
   * @param obj the object to check
   * @param message a message which will be prepended to the message generated by this method in order to provide
   * further context. It should normally end in ":" or "." so that the generated message looks OK when appended to it.
   * @throws IllegalArgumentException if the object is not an instance of type
   * @see Class#isInstance
   */
  ...
  /**
   * Assert a boolean expression, throwing an {@link IllegalStateException} if the expression evaluates to {@code
   * false}.
   * <p>
   * Call {@link #isTrue} if you wish to throw an {@code IllegalArgumentException} on an assertion failure.
   *
