...
public abstract class ClassUtils {
     ...
     *             if the class name was not resolvable (that is, the class could not be found or the
     ...
     * as synthetic anyway). Note that, despite being synthetic, bridge methods ({@link Method#isBridge()}) are
     * considered
     ...
     * the
     * specified resource name to this. <br/>
     ...
     *            the class to analyze for interfaces
     * @param classLoader
     *            the ClassLoader that the interfaces need to be visible in (may be {@code null} when accepting
     ...
     * @param classLoader
     *            the ClassLoader to check against (may be {@code null}, in which case this method will always
     *            return {@code true})
     */
