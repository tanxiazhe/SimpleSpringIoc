...
public abstract class ClassUtils {
   ...
   * non-null ClassLoader reference: for example, for class path resource loading (but not necessarily for {@code
   * Class.forName}, which accepts a {@code null} ClassLoader reference as well).
   *
   ...
   * class names (e.g. "String[]"). Furthermore, it is also capable of resolving inner class names in Java source style
   ...
   *
   * @param method the method
   * @param clazz the clazz that the method is being invoked on (may be {@code null} to indicate the method's declaring
   * class)
   * @return the qualified name of the method
   * @since 4.3.4
   */
   ...
   * class file, converting all dots ('.') to slashes ('/'), adding a trailing slash if necessary, and concatenating the
   * specified resource name to this. <br/> As such, this function may be used to build a path suitable for loading a
   * resource file that is in the same package as a class file, although {@link org.springframework.core.io.ClassPathResource}
